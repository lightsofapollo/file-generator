...
Generator.prototype = {
   ...
   * .run on the given object. 
   * Used for the queue's to dry up 
   * function creation.
   *
   * @param {Object} object
   */
  _runObject: function(object){
    return function(){
      object.run(this);
    };
  },
  ...
  run: function(callback){
    ...
    Step(
      this._runObject(queue.questions),
      this._runObject(queue.directories),
      this._runObject(queue.files),
